...
const RecieptPopup = ({ setactive }) => {
  return (
    <>
      {" "}
      <div className="receipt-blur"></div>
      <div className="section-receipt" onClick={() => setactive(false)}>
        <div className="centre">
          <div className="receipt">
            <div className="heading">
              <h2>Transaction Receipt</h2>
              <img alt="cancel" src={cancel} onClick={() => setactive(false)} />
            </div>
            ...
            <div className="button-down">
              <Box3 text="Close" onClick={() => setactive(false)} />
              <Box4 text="Download" />
            </div>
          </div>
        </div>
